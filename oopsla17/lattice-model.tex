...
%
  ...
  \todo{%
    ...
    Subscript spaces model array subscript expressions in our source language
...
\todo{On the following, add some intuition first- what is this and
  what is it for?}
