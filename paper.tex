...
\begin{definition}[Base induction variable]
  ...
  loop,\footnote{Or equivalent in the source language \eg{}
...
%%
There are two modifiers: one used at specification and the other at region
...
\subsubsection{A note on region approximations}
...
The Unified Model contains an implementation of the Smagorinsky subgrid-scale model for calculating turbulence. The source file in question yields 38 stencils from 340 lines of code. We selected one as an example:
