...
\newcommand{\cons}[3]{#2 \;\, \textbf{consistent} \,\, #1}
\begin{align*}
\dfrac{\forall u \in C, \exists v \in S .  \, u \preceq v}
      {\cons{\mathsf{up}(S)}{C}{n}}
\qquad
\dfrac{\forall v \in S, \exists u \in C . \, u \preceq v}
      {\cons{\mathsf{low}(S)}{C}{n}} \\[0.75em]
\dfrac{\cons{\mathsf{down}(S)}{C}{n} \qquad \cons{\mathsf{up}(S)}{C}{n}}
  {\cons{\mathsf{exact}(S)}{C}{n}} \\[0.75em]
\dfrac{\cons{\mathsf{down}(S_1)}{C}{n} \qquad \cons{\mathsf{up}(S_2)}{C}{n}}
  {\cons{\mathsf{both}(S_1, S_2)}{C}{n}}
\end{align*}
