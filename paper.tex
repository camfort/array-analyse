...
\end{minted}
%
The consistency function would have held because for the upper bound
$\mathit{cons}(\textsf{mult}(\textsf{up}(m)),L3',b)$ would never have
been needed. This semantically makes sense since the region
$\texttt{fivepoint}$ is indeed a lower bound for the access pattern of
$b$.
