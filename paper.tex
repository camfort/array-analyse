...
We define the interpretation function $\inter{-}$ overloaded on regions
in Figure~\ref{fig:region-model} and on the top-level of 
a specification \textit{specTop} in
Figure~\ref{fig:spatial-model}. Some
