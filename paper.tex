...
much more rigid however, there is only one way to unify two
index schemes in our model.
...
wrt to tensor. I can't work it out either! Mistral have another
...
\hline
Package       & {Files} & {Lines of code} & {Files analysed} \\ % braces prevent headers from being formatted as numbers
\hline
