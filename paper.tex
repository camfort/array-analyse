...
with a specification. This will be formalised in \S~\ref{sec:semantics} and
...
all parts of the region should have an index corresponding it.
...
\emph{generalisation} (Def.~\ref{def:generalisation}).
...
(\S~\ref{subsec:analysis}) to extract index schemes from source code,
...
Figure~\ref{fig:inference-steps-informal}(a).
...
in Figure~\ref{fig:to-spec}, where the lower and upper bounds
