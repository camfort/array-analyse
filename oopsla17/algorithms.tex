...
constants. Each interval scheme is connected with \texttt{+} and each dimension
of the interval scheme is connected with \texttt{*}. The intervals at each
dimension are mapped to region constants using the bijection defined in
\Cref{sec:semantics}.

In the example, $[-1, 1] \times [0, 0]$ is mapped to \texttt{\stencil{c}{1}{1}{}
* \stencil{p}{2}{}{}} and $[0, 0] \times [-1, 1]$ is mapped to
\texttt{\stencil{p}{1}{}{} * \stencil{c}{2}{1}{}}, producing the overall
specification:
%
\begin{equation*}
