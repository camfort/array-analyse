...
In this paper, we described an abstract specification language 
for the access pattern of a stencil computation. Compared with the
...
provides a set of abstract spatial combinators which capture a large number
of common patterns. 
...
tool\footnote{\url{https://github.com/camfort/camfort}} for Fortran
