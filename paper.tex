...
\begin{abstract}
  ...
  errors. We hypothesise that in practice, stencil computations tend
...
\item we provide an implementation of our approach as an extension to
  CamFort, an open-source program analysis tool for Fortran programs;

\item we identified 35,000 stencils in one million lines of code. Approximately 
10\% of the stencils we found correspond to code where an indexing error is plausible;
...
mapping individual indexing expressions to 
