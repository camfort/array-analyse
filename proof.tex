...
\begin{description}
  ...
  \item[\textsc{Case *ASSOC}:] We have $\interp{r_1 \; \texttt{$\ast$} \;
    ...
    \begin{align}
      b_l &= b_i \vee b_j & \mbox{, by negating $(3)$ and applying De Morgan's law} \\
      b_j &= b_k \wedge (b_i \vee b_j) & \mbox{, by substituting $(4)$ into $(1)$} \\
      b_i \wedge \neg b_j &= \neg b_k \wedge (b_i \vee b_j) & \mbox{, by substituting $(4)$
        into $(2)$} \\
      b_j \vee b_i \wedge \neg b_j &= b_k \wedge (b_i \vee b_j) \vee \neg b_k \wedge (b_i \vee b_j) & \mbox{, by disjunction of $(5)$ and $(6)$} \\
      b_i \vee b_j &= b_i \vee b_j & \mbox{, by algebraic simplification of (7)} \nonumber
    \end{align}
