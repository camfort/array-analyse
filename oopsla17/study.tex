...
computations (88,577) have a static pattern that comprises
constant offsets of base/derived induction variables (potential with
some absolute indices), confirming
...
dimensions). The ``affine + absolute'' class is
