...
for C (see \eg{}~\citet[Example 3.4.1]{burghardt2010acsl}). A specification
can be given for a stencil computation, 
however, such specification would replicate the fine-grained
indexing seen in the code and would be similarly prone to indexing
