...
\anote{Can we say something here about why these equations are useful i.e. we use them to do simplification of stencils?}
...
semantics, in terms of sets of vectors which we call \emph{index
  schemes}. We introduce these first and then define the denotational semantics.
...
and \textsf{Approx} are parametric labelled variant (sum) types
...
on. These are used for labelled models, and other components later in
