...
% For evaluation and empirical study
...
\begin{abstract}
  ...
  eleven real-world computational science code base, identifying
  ...
  detected by our approach. We found roughly 80,000 targets for
  specification across roughly 1.4 million lines of code, showing that the
