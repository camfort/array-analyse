...
The upper bound is established by \emph{elongating} index schemes in multiple
...
of the lower bound. The solution is to use \Cref{lem:vector-union} to break this
