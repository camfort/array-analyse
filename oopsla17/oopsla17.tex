...
%  is a subset of $\mathcal{P}{(\bz{})^N}$ since all interval schemes are
%  subsets of this power set and; union and intersection cannot add an element
%  that is not already in the powerset. The inductive definition ensures that
%  \region{N} is closed under these operations. Therefore, \region{N} is a
%  distributive sublattice of $(\mathcal{P}{(\bz{})^N}, \subseteq)$.
\end{proof}
