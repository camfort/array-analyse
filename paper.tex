...
\begin{abstract}
  ...
  mathematical model. For example, a system of partial differential equations
  (PDEs) specifies a relationship between variables, but tools for encoding such
  a specification, and pertinent properties such as convergence and
